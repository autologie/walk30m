window.messages = {
  ...
  summaryTpl:
    "The area within <%= timeExpr %> minutes <%= travelModeExpr %> from <%= originAddress %>",
  tweetMessageTpl:
    "The area within <%= timeExpr %> minutes <%= travelModeExpr %> from <%= originAddress %>:",
  ...
  searching:
    "Computing the area within <%= min %> minutes <%= travelModeExpr %> from <%= address %>...",
  ...
  geolocationForbidden:
    "Please allow this application to use location information.",
  ...
  askIfReload:
    "It seems that the compution is taking long time. This problem may be resolved by reloading the web page. Would you like to reload now?",
  failedToSendMEssage:
    "Oops! Something bad happend and your message is not sent.",
